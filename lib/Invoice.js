...
export class Invoice {
  constructor (options) {
    ...
    this._options.adjustmentInvoice = options.adjustmentInvoice || false
  ...
  _generateXML (indentLevel) {
    ...
    assert(!(this._options.adjustmentInvoice === true && typeof this._options.adjustmentInvoiceNumber === 'undefined'), 'If adjustmentInvoice is true, adjustmentInvoiceNumber must be specified.');
